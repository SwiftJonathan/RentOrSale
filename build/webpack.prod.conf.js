...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    /*new manifestPlugin({
      name: '哈喽交易', // 标题 指定了Web App的名称。
      short_name: '哈喽', // 短标题 short_name其实是该应用的一个简称。一般来说，当没有足够空间展示应用的name时，系统就会使用short_name。
      description: '哈喽交易 - 一款最前线新闻的应用', // 这个字段的含义非常简单，就是一段对该应用的描述。
